    ...
    return (
        <>
            ...
            <motion.div
                ...
                className="fixed top-10 right-8 z-50 mt-2 w-fit rounded-xl border border-(--dock-border) bg-(--dock-bg) p-4 px-6 pb-6 shadow-2xl backdrop-blur-md"
            >
                <div className="flex flex-col items-start justify-center gap-2">
                    ...
                    <div className="text-md flex flex-col items-start justify-center gap-3 font-semibold text-(--text-primary)">
