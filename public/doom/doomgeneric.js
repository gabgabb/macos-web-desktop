...
(() => {
    ...
    loadPackage({
        files: [
            { filename: "/doom-ori.wad", start: 0, end: 11159840 },
            { filename: "/doom-ud.wad", start: 11159840, end: 23568132 },
            { filename: "/doom2.wad", start: 23568132, end: 38172716 },
        ],
        remote_package_size: 38172716,
    });
})();
            ...
            for (var i = 0; i < parts.length; i++) {
                ...
                if (parts[i] === "..") {
                    ...
                    if (FS.isRoot(current)) {
                        path =
                            current_path + "/" + parts.slice(i + 1).join("/");
...
var _doomgeneric_key_event = (Module["_doomgeneric_key_event"] =
    makeInvalidEarlyAccess("_doomgeneric_key_event"));
var _doomgeneric_mouse_event = (Module["_doomgeneric_mouse_event"] =
    makeInvalidEarlyAccess("_doomgeneric_mouse_event"));
...
function assignWasmExports(wasmExports) {
    ...
    assert(
        typeof wasmExports["doomgeneric_key_event"] != "undefined",
        "missing Wasm export: doomgeneric_key_event",
    );
    assert(
        typeof wasmExports["doomgeneric_mouse_event"] != "undefined",
        "missing Wasm export: doomgeneric_mouse_event",
    );
    assert(
    ...
    _doomgeneric_key_event = Module["_doomgeneric_key_event"] =
        createExportWrapper("doomgeneric_key_event", 2);
    _doomgeneric_mouse_event = Module["_doomgeneric_mouse_event"] =
        createExportWrapper("doomgeneric_mouse_event", 3);
