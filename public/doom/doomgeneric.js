...
// include: /tmp/tmp6j3zxn40.js
  ...
  (() => {
    ...
    loadPackage({"files": [{"filename": "/doom-ori.wad", "start": 0, "end": 11159840}, {"filename": "/doom-ud.wad", "start": 11159840, "end": 23568132}, {"filename": "/doom2.wad", "start": 23568132, "end": 38172716}], "remote_package_size": 38172716});

  })();

// end include: /tmp/tmp6j3zxn40.js
// include: /tmp/tmpf2svu1n4.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpf2svu1n4.js
// include: /tmp/tmpzg3dgqap.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpzg3dgqap.js
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['doomgeneric_key_event'] != 'undefined', 'missing Wasm export: doomgeneric_key_event');
  assert(typeof wasmExports['doomgeneric_mouse_event'] != 'undefined', 'missing Wasm export: doomgeneric_mouse_event');
  ...
  _doomgeneric_key_event = Module['_doomgeneric_key_event'] = createExportWrapper('doomgeneric_key_event', 2);
  _doomgeneric_mouse_event = Module['_doomgeneric_mouse_event'] = createExportWrapper('doomgeneric_mouse_event', 3);
